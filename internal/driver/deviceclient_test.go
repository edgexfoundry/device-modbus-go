...
func TestTransformCommandValueToDataBytes_INT16(t *testing.T) {
	...
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeInt16, int16(-25))
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_INT32(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeInt32, int32(267))
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_INT64(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeInt64, int64(281474976841985))
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_UINT16(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeUint16, uint16(11))
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{0, 11}
...
func TestTransformCommandValueToDataBytes_UINT32(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeUint32, uint32(267))
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{0, 0, 1, 11}
...
func TestTransformCommandValueToDataBytes_UINT64(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeUint64, uint64(281474976841985))
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{0, 1, 0, 0, 0, 2, 1, 1}
...
func TestTransformCommandValueToDataBytes_FLOAT32(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat32, float32(1.12))
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_FLOAT64(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat64, 1.12)
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_BOOL(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeBool, true)
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{1}
...
func TestTransformCommandValueToDataBytes_ValueType_FLOAT32_RawType_INT16(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat32, float32(-52.0))
	require.NoError(t, err)
	val.Origin = resTime
...
func TestTransformCommandValueToDataBytes_ValueType_FLOAT32_RawType_UINT16(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat32, float32(112.1))
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{0, 112}
...
func TestTransformCommandValueToDataBytes_ValueType_FLOAT64_RawType_INT16(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat64, -52.0)
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{255, 204}
...
func TestTransformCommandValueToDataBytes_ValueType_FLOAT64_RawType_UINT16(t *testing.T) {
	...
	require.NoError(t, err)
	resTime := time.Now().UnixNano()
	val, err := models.NewCommandValue(req.DeviceResourceName, v2.ValueTypeFloat64, 112.1)
	require.NoError(t, err)
	val.Origin = resTime
	expected := []byte{0, 112}
